...
**Question 6**  Find clusters at different resolutions: Find clusters at resolution e.g. 0.1, 0.4 and 0.6. Save the plots in p2, p3 and p4 plots and thereafter plot all four plots together. Find what differs when changing these resolutions.
